...
export const ${ACTION_NAME_CAMELIZED}Actions = {
  FETCH_${ACTION_NAME_UPPERCASE}_REQUEST: '${ACTION_NAME_CAMELIZED}Actions/FETCH_${ACTION_NAME_UPPERCASE}_REQUEST',
  ...
  FETCH_${ACTION_NAME_UPPERCASE}_FAILURE: '${ACTION_NAME_CAMELIZED}Actions/FETCH_${ACTION_NAME_UPPERCASE}_FAILURE',
