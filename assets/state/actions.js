...
export const ${ACTION_IMPORT_NAME} = {
  FETCH_${ACTION_NAME_UPPERCASE}_REQUEST: '${ACTION_IMPORT_NAME}/FETCH_${ACTION_NAME_UPPERCASE}_REQUEST',
  ...
  FETCH_${ACTION_NAME_UPPERCASE}_SUCCESS: '${ACTION_IMPORT_NAME}/FETCH_${ACTION_NAME_UPPERCASE}_SUCCESS',
  ...
  FETCH_${ACTION_NAME_UPPERCASE}_FAILURE: '${ACTION_IMPORT_NAME}/FETCH_${ACTION_NAME_UPPERCASE}_FAILURE',
